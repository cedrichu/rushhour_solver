...
@date    2009-02-09
@version $Id: generateTripsXml.py 17235 2014-11-03 10:53:02Z behrisch $
...
def main(options):
    ...
    print >> fouttrips, """<!-- generated on %s by $Id: generateTripsXml.py 17235 2014-11-03 10:53:02Z behrisch $ -->
