...
@date    2013-01-15
@version $Id: ns2.py 17235 2014-11-03 10:53:02Z behrisch $
...
def writeNS2activity(outSTRM, vehInfo):
  for v in vehInfo:
    i = vehInfo[v]
    print('$ns_ at %s "$g(%s) start"; # SUMO-ID: %s' % (i[1], i[0], v), file=outSTRM)
    print('$ns_ at %s "$g(%s) stop"; # SUMO-ID: %s' % (i[2], i[0], v), file=outSTRM)
